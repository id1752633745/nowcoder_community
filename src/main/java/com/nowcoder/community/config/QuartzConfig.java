...
public class QuartzConfig {
    ...
    public SimpleTriggerFactoryBean postScoreRefreshTrigger(JobDetail postScoreRefreshJobDetail) {
        ...
        simpleTriggerFactoryBean.setRepeatInterval(1000 * 3600 * 2);
        simpleTriggerFactoryBean.setJobDataAsMap(new JobDataMap());
        return simpleTriggerFactoryBean;
    }

    // FactoryBean 可以简化 Bean 的实例化过程
...
//    }
//
//    // 配置 Trigger （SimpleTriggerFactoryBean, CoreTriggerFactoryBean）
////    @Bean
